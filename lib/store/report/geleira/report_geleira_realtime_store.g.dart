...
part of 'report_geleira_realtime_store.dart';
...
mixin _$ReportGeleiraRealTimeStore on _ReportGeleiraRealTimeStore, Store {
  ...
  ObservableList<ReportGeleiraModel> get getInformations =>
      (_$getInformationsComputed ??=
              Computed<ObservableList<ReportGeleiraModel>>(
                  ...
                  name: '_ReportGeleiraRealTimeStore.getInformations'))
          .value;

  final _$isLoadingAtom = Atom(name: '_ReportGeleiraRealTimeStore.isLoading');
  ...
  final _$listaGeleirasAtom =
      Atom(name: '_ReportGeleiraRealTimeStore.listaGeleiras');
  ...
  final _$findAllGeleirasAsyncAction =
      AsyncAction('_ReportGeleiraRealTimeStore.findAllGeleiras');
