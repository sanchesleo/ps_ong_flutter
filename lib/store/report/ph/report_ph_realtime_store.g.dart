...
part of 'report_ph_realtime_store.dart';
...
mixin _$ReportPHRealtimeStore on _ReportPHRealtimeStoreBase, Store {
  ...
  ObservableList<ReportPHModel> get getInformations =>
      (_$getInformationsComputed ??= Computed<ObservableList<ReportPHModel>>(
              ...
              name: '_ReportPHRealtimeStoreBase.getInformations'))
          .value;

  final _$isLoadingAtom = Atom(name: '_ReportPHRealtimeStoreBase.isLoading');
  ...
  final _$listaPhAtom = Atom(name: '_ReportPHRealtimeStoreBase.listaPh');
  ...
  final _$findAllPhsAsyncAction =
      AsyncAction('_ReportPHRealtimeStoreBase.findAllPhs');
