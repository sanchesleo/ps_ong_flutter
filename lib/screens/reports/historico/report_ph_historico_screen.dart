...
import 'package:ps_app_ong/store/report/ph/report_ph_historico_store.dart';

class ReportPHHistoricoScreen extends StatefulWidget {
  const ReportPHHistoricoScreen({Key? key}) : super(key: key);

  @override
  _ReportPHHistoricoScreenState createState() =>
      _ReportPHHistoricoScreenState();
}

class _ReportPHHistoricoScreenState extends State<ReportPHHistoricoScreen> {
  @override
  Widget build(BuildContext context) {
    ScreenArguments reportCategorie =
        ModalRoute.of(context)!.settings.arguments as ScreenArguments;

    ReportPHHistoricoStore reportPHStore = ReportPHHistoricoStore();
