...
import 'package:ps_app_ong/store/report/geleira/report_geleira_historico_store.dart';

class ReportGeleiraHistoricoScreen extends StatefulWidget {
  const ReportGeleiraHistoricoScreen({Key? key}) : super(key: key);

  @override
  _ReportGeleiraHistoricoScreenState createState() =>
      _ReportGeleiraHistoricoScreenState();
}

class _ReportGeleiraHistoricoScreenState
    extends State<ReportGeleiraHistoricoScreen> {
  @override
  Widget build(BuildContext context) {
    ScreenArguments reportCategorie =
        ModalRoute.of(context)!.settings.arguments as ScreenArguments;

    ReportGeleiraHistoricoStore reportGeleiraStore =
        ReportGeleiraHistoricoStore();
