...
import 'package:ps_app_ong/repository/reports/report_poluicao_repository.dart';
import 'package:ps_app_ong/screens/loading/report_loading.dart';
import 'package:ps_app_ong/store/report/poluicao/report_poluicao_realtime_store.dart';

class ReportPoluicaoRealtimeScreen extends StatefulWidget {
  const ReportPoluicaoRealtimeScreen({Key? key}) : super(key: key);

  @override
  _ReportPoluicaoRealtimeScreenState createState() =>
      _ReportPoluicaoRealtimeScreenState();
}

class _ReportPoluicaoRealtimeScreenState
    extends State<ReportPoluicaoRealtimeScreen> {
  @override
  Widget build(BuildContext context) {
    ScreenArguments reportCategorie =
        ModalRoute.of(context)!.settings.arguments as ScreenArguments;

    ReportPoluicaoRealtimeStore reportPoluicaoStore =
        ReportPoluicaoRealtimeStore();
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${reportCategorie.reportTitle} - 2021',
