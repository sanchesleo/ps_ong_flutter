...
import 'package:ps_app_ong/store/report_categorie_realtime_store.dart';

class ReportCategorieRealtimeScreen extends StatefulWidget {
  const ReportCategorieRealtimeScreen({Key? key}) : super(key: key);

  @override
  _ReportCategorieRealtimeScreenState createState() =>
      _ReportCategorieRealtimeScreenState();
}

class _ReportCategorieRealtimeScreenState
    extends State<ReportCategorieRealtimeScreen> {
  late ReportCategorieRealTimeStore _store;
  ...
  @override
  void initState() {
    _store = ReportCategorieRealTimeStore();
    super.initState();
  }
